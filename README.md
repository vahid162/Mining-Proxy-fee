...
- `V2RAYA_IMAGE`, `V2RAYA_V2RAY_BIN`, `GOST_IMAGE`
- `V2RAYA_UI_BIND_HOST`, `V2RAYA_UI_PORT`
- `DOCKER_LOG_MAX_SIZE`, `DOCKER_LOG_MAX_FILE`

`V2RAYA_V2RAY_BIN` به‌صورت پیش‌فرض روی `v2ray` تنظیم می‌شود (v2ray-core). اگر بخواهی Xray استفاده کنی، مقدارش را `xray` بگذار.
